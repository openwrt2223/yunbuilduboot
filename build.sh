...
cd /yunbuilduboot/
wget https://downloads.openwrt.org/snapshots/targets/ramips/mt7620/openwrt-toolchain-ramips-mt7620_gcc-14.3.0_musl.Linux-x86_64.tar.xz -O openwrt-toolchain-ramips-mt7620_gcc-14.3.0_musl.Linux-x86_64.tar.xz
tar -xvf openwrt-toolchain-ramips-mt7620_gcc-14.3.0_musl.Linux-x86_64.tar.xz
rm -rf openwrt-toolchain-ramips-mt7620_gcc-14.3.0_musl.Linux-x86_64.tar.xz
